...
export const schemasMap: Record<string, z.ZodSchema<any>> = {
  abastecimento_bom_prato: AbastecimentoBomPratoSchema,
  abastecimento_feiras_livres: AbastecimentoFeirasLivresSchema,
  abastecimento_mercados_municipais: AbastecimentoMercadosMunicipaisSchema,
  abastecimento_sacolao: AbastecimentoSacolaoSchema,
  ...
  parques_unidades_conservacao: ParquesUnidadesConservacaoSchema,
  pontos_onibus: PontosOnibusSchema,
  pontos_shopping: PontosShoppingSchema,
  protecao_mulher: ProtecaoMulherSchema,
  seguranca_bombeiro: SegurancaBombeiroSchema,
  seguranca_bombeiro_sad: SegurancaBombeiroSadSchema,
  seguranca_casa_mediacao: SegurancaCasaMediacaoSchema,
  seguranca_casa_mediacao_sad: SegurancaCasaMediacaoSadSchema,
  seguranca_policia_civil: SegurancaPoliciaCivilSchema,
  seguranca_policia_civil_sad: SegurancaPoliciaCivilSadSchema,
  seguranca_policia_militar: SegurancaPoliciaMilitarSchema,
  seguranca_policia_militar_sad: SegurancaPoliciaMilitarSadSchema,
  servico_cat: ServicoCatSchema,
  servico_ccz: ServicoCczSchema,
  servico_consulado: ServicoConsuladoSchema,
  servico_correios: ServicoCorreiosSchema,
  servico_descomplica: ServicoDescomplicaSchema,
  servico_enel: ServicoEnelSchema,
